...
public class SendMessage {
     ...
     * @return
     */
    public static MessageTeamplate insertLeaseSalesman(String salesmanName,String tenantName,String leaseNo, BigDecimal rentPrice, BigDecimal depositPrice, BigDecimal total, String chargeText){
        ...
        teamplate.setContentText("您的房客"+tenantName+"成功签订租约（编号"+leaseNo+"），本期租金"+rentPrice+"元，" +
                "押金"+depositPrice+"元，"+chargeText+"合计"+total+"元，请及时完成支付，逾期租约将失效！");
        return teamplate;
    }
