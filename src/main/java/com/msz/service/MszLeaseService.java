...
public interface MszLeaseService extends IService<MszLease> {
     ...
     * 新增租约
     * @param  lease
     * @param  leaseChargeList
     * @return
     */
    boolean insertMszLease(MszLease lease, List<MszLeaseCharge> leaseChargeList);
   ...
   /* *
     ...
     * @return
     */
    boolean updateMszLease(MszLease lease);
    ...
    **/
    ...
    List<AchievementVo> getMszLeaseListByUser(PagingRequest pagingRequest, Integer userId, int type);

    int getMszLeaseListByUserSums(Integer userId, int type);
}
